...
knitr::include_graphics("_bookdown_files/_main_files/figure-html/fig-cap3-1.png")
```
...
```{r echo=FALSE, out.width = '100%', dpi = 300}
knitr::include_graphics("_bookdown_files/_main_files/figure-html/fig-cap3-2.png")
```
